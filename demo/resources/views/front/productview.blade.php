...
<!-- Sidebar end=============================================== -->
	...
	<div class="row">	  
            ...
            <a href="themes/images/products/large/f1.jpg" title="Fujifilm FinePix S2950 Digital Camera">
				<img src="{{$product->product_details->image}}" style="width:100%" alt="Fujifilm FinePix S2950 Digital Camera"/>
            </a>
			...
			<div class="span6">
				<h3>{{$product->product_details->title}} </h3>
				<small>- (14MP, 18x Optical Zoom) 3-inch LCD</small>
				<hr class="soft"/>
				<form class="form-horizontal qtyFrm">
				  <div class="control-group">
					<label class="control-label"><span>${{$product->product_details->price}}</span></label>
					<div class="controls">
				...
				<hr class="soft"/>
				<h4>{{$product->product_details->totle_items}}items in stock</h4>
