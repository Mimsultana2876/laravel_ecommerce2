		...
		<div class="row-fluid">
			<div id="featured" class="carousel slide">
				<div class="carousel-inner">
					...
					@php $i=1; @endphp
				   <div class="item  @if($i==0) @endif active">
						...
						<ul class="thumbnails">
							...
							<div class="thumbnail">
								<i class="tag"></i>
								<a href="{{route('productview',$value->id)}}"><img src="{{asset('uploads/'.$value->image)}}
								" alt=""></a>
								<div class="caption">
								<h5>{{$value->name}}</h5>
								<h4><a class="btn" href="{{route('productview',$value->id)}}">
									VIEW</a> <span class="pull-right">${{$value->price}}</span></h4>
								</div>
							</div>
							</li>
						@endforeach
				...
				<li class="span3">
				  <div class="thumbnail">
					...
					<div class="caption">
					  ...
					  <h4 style="text-align:center"><a class="btn" href="{{asset('prodcutview')}}"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart">

					  </i></a> <a class="btn btn-primary" href="#">${{$new_product->price}}</a></h4>
					</div>
				  </div>
				</li>
				@endforeach
